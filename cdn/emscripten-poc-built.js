...
/** not-@type {!BigUint64Array} */ HEAPU64;
		...
		var wasmBinaryFile;
		console.log({ wasmBinaryFile, line: 478 });

		function findWasmBinary() {
			console.log("callingLocatFile");
			return locateFile("emscripten-poc-built.wasm");
		}

		function getBinarySync(file) {
			console.log({ wasmBinaryFile, line: 485 });
...
} else if (typeof define === "function" && define["amd"]) define([], () => emscriptenPOC);
